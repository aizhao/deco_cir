...
from lavis.models.blip2_models.blip2_avgpool_cir_align_prompt import Blip2AvgPoolCirAlignPrompt
from lavis.models.blip2_models.blip2_deco_sprc import SPRC_DeCo
